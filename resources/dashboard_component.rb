...
string_attrs = %w(title vtitle description major_grid_line_color minor_grid_line_color from until timezone)
...
int_attrs.each do |attr_int|
  attribute attr_int, kind_of: Integer, required: false
end
